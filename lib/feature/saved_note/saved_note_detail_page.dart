...
import 'package:suitcore_note/feature/saved_note/saved_note_detail_controller.dart';
...
class SavedNoteDetailPage extends GetView<SavedNoteDetailController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<SavedNoteDetailController>(
                ...
                ? SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          DateFormat('dd MMM yyyy kk:mm').format(DateTime.parse(
                        ...
                        const SizedBox(height: 5),
                        GetBuilder<SavedNoteDetailController>(
                          init: SavedNoteDetailController(),
                          initState: (_) {},
                          builder: (_) {
                            return Wrap(
